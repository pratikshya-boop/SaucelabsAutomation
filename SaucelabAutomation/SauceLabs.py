...
for i, user_data in enumerate(test_search_data):
    ...
    # send_keys_to_element(driver, login_email, user_data["email"])
    #
    # login_password = "//input[@id='customer_password']"
    # send_keys_to_element(driver, login_password, user_data["password"])
    #
...
#Now checkout after going in cart
check_out_btn = "//input[@id='checkout']"
click_element(driver, check_out_btn)
time.sleep(30)
